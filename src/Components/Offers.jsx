...
const Offers = ({ hideHeading = false }) => {
  return (
    <div className="relative w-full py-12 px-4 sm:py-16 sm:px-6 lg:py-20 lg:px-16 bg-white shadow-lg">
      ...
      {!hideHeading && (
        <h2
          className="text-center mb-8 text-2xl sm:text-3xl font-bold text-gray-800"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
        ...
        <div className="bg-white shadow-lg p-6 sm:p-8 rounded-lg text-center">
          <div className="mb-4">
            <img
              src={DeliveryImage}
              alt="Free Shipping"
              className="mx-auto w-12 h-14 sm:w-14 sm:h-16"
            />
          </div>
          <h3
            className="text-lg sm:text-xl font-semibold text-[#151875] mb-2"
            style={{ fontFamily: "Josefin Sans" }}
          >
            Free Shipping
          </h3>
        ...
        {/* Feature 4: High-Quality Products */}
        <div className="bg-white shadow-lg p-6 sm:p-8 rounded-lg text-center">
          <div className="mb-4">
            <img
              src={ServiceImage}

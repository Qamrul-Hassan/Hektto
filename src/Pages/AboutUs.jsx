  ...
  return (
    <PageLayout pageTitle="About Us">
      ...
      <div className="container mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
        ...
        <div>
          ...
          <button
            ...
            className="bg-pink-500 text-white px-6 py-2 rounded-md hover:bg-pink-600 transition duration-300 font-lato"
          >
            Contact Us
          </button>
        </div>
      ...
      <div className="container mx-auto px-6 py-12 text-center">
        ...
        <p className="text-lg text-[#333333] mb-4 leading-relaxed font-lato">
        ...
        <p className="text-lg text-pink-500 font-semibold font-lato">Selina Gomez</p>
      </div>
    </PageLayout>
  );
};
